...
**Note on database versions**: The below databases have been pre-loaded to work with Kùzu version 0.2.x ([0.2.0](https://github.com/kuzudb/kuzu/releases/tag/v0.2.0) and [0.2.1](https://github.com/kuzudb/kuzu/releases/tag/v0.2.1)).
