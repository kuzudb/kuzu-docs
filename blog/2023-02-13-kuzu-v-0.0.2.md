...
new [`QueryResult.get_as_networkx()`](/docs/client-apis/python-api/query-result#query_result.QueryResult.get_as_networkx) function that can convert query results
