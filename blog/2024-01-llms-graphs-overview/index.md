...
- **Impressive simplicity and effectiveness of developing a natural language interface over your database using LLMs**: The engineering efforts
  to develop a pipeline that delivered a natural language interface over your database in pre-LLM era was immense.
  This contrasts sharply with the simplicity of giving the same functionality (good or bad) using LLMs. This simplicity is worth appreciating. Further
  there is evidence that LLMs, if prompted correctly, will generate many queries with impressive accuracy.
...
reflects on the reading I did on RAG on structured data.*
...
Post-LLM approaches
require none of this effort because LLMs, such as GPT-4, already speak SQL, Cypher, and SPARQL out of the box. Same datasets
