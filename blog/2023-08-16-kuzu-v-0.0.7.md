...
- [Kùzu 0.0.7 Release](#kùzu-007-release)
...
In this release, we introduced the concept *NodeGroup*, which is equivalent to [*RowGroup*](https://parquet.apache.org/docs/concepts/) in the sense that they both represent a horizontal partition of a table.[^1] 
