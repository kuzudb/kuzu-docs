...
In this release, we introduced the concept *NodeGroup*, which is equivalent to [*RowGroup*](https://en.wikipedia.org/wiki/Column_groups_and_row_groups) in the sense that they both represent a horizontal partition of a table.[^1] 
