...
We have gained 10x performance improvement by implementing our new copy-to framework on ldbc-100 comment table:

Query: `copy (match (p:Comment) return p.*) to ‘comment.csv’;`
| Release Version | Performance (s) |
|------------------|-------------------|
| v0.0.10          | 1239.314          |
| v0.1.0           | 104.550           |
