...
Details can be found in the [LOAD FROM documentation page](/cypher/load_from).
...
If a header is manually specified, Kùzu will try to cast to the given type and throw exceptions if casting fails. More information can be found [here](/cypher/load_from).
