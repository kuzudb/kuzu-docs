...
See [Create Table](./../cypher/data-definition/create-table.md) for more information.
...
If multi-line strings are present, the CSV reading will fail, and you will need to fall back to single thread mode by setting `parallel=false`. See [Data Import from CSV Files](./../data-import/csv-import.md#data-import-from-csv-files).
