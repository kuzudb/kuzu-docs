...
With projection, the optimizer can completely avoid materialzing a hash table for rel properties which is bottleneck of computation.

[^1]: This is an experimental feature and might be changed in the future.
[^2]: This experiement is carries of a m1 mac pro with 16GB of memory. Maximum execution thread is set to 8. Sideway information passing is disabled.