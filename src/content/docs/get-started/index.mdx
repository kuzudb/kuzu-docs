...
Because Kùzu is an embedded database, you can simply import the `kuzu` module in your client of choice
and start interacting with the database. Cypher queries can be passed as string literals
to the `execute` (or equivalent) method in the respective client.
