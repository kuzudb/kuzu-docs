...
for anyone who is familiar with SQL. Kùzu's implementation
...
in the [previous section](/get-started). For a detailed guide on using Cypher in Kùzu and to see all the
...
For simplicity, we'll demonstrate how to run Cypher queries in this section using Kùzu Explorer
