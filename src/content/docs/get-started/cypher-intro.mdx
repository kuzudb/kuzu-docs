...
description: "Learn how to query graphs using Cypher and visualize results in Kuzu"
---
...
such as `kuzudb/explorer:0.xx.0`. The explorer version must match the Kuzu version used to create
