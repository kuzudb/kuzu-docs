...
<LinkCard
  title="Kùzu NIF for Elixir"
  description="The NIF package is maintained by an independent, external contributor."
  href="https://github.com/bgoosmanviz/kuzu_nif"
/>
...
The Elixir NIF package is maintained as an independent, external open source project contributed by [Kineviz, Inc.](https://www.kineviz.com/)
