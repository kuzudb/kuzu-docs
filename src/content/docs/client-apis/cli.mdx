...
#### `:multiline`
Set multiline editing mode. In multiline editing mode, you can write queries that span multiple lines. In this mode, you are able to go back
...
#### `:singleline`
Set singleline editing mode. This is the default editing mode. In singleline editing mode, you can only write queries on a single line.
