...
ExternalProject_Add(kuzu-prebuilt
    URL https://github.com/kuzudb/kuzu/releases/download/v${version}/libkuzu-linux-x86_64.tar.gz
)
...
See the requirements in https://docs.kuzudb.github.io/developer-guide/.
