...
| `WARNING_LIMIT` | Maximum number of [warnings](/import/ignoring-erroneous-rows#warnings-table-inspecting-skipped-rows) that can be stored in a single connection. | 8192        |
