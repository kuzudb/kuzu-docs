...
The JSON data type is not natively available in Kùzu, and requires the [JSON extension](/extensions/json)
:::

Using the Kùzu JSON extension, you can model store properties as JSON natively via the `JSON`
