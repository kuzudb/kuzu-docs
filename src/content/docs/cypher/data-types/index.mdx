...
Kùzu supports two `LIST` data types: fixed-length lists, called `ARRAY`, and variable-length lists,
simply called `LIST`. Click on the card below to learn more about them.

<LinkCard
  title="List"
  href="/cypher/data-types/list"
  description="LIST and ARRAY data types"
/>
