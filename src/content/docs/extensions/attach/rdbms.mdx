...
The `sql_query` table function allows users to execute any read SQL queries on any attached POSTGRESQL database and retrieve the result. The function takes in two parameters:
