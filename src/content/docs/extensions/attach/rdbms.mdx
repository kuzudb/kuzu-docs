...
Note: Kuzu also allows users to attach a remote DuckDB database, which may be hosted on S3 or HTTPFS. However, the httpfs extension must be loaded beforehand.
