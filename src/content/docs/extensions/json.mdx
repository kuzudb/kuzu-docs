...
```cypher
RETURN json_object('KEY1', NULL, 'KEY2', 5)
```
```json
{"KEY1":null,"KEY2":5}
```
...
```cypher
RETURN json_merge_patch('{"kuzu": 114}', '{"goose": 514}');
```
Output:
```json
{"kuzu":114,"goose":514} 
