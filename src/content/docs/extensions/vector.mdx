...
for accelerating similarity search over vector embeddings (32-bit and 64-bit float arrays) stored in Kuzu. Currently, indexing is only supported for vectors stored as node table properties.
