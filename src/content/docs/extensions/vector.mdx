...
- `mu`
  ...
  - A higher value leads to a more accurate index, but increase the index size and construction time.
  - Default: `30`
- `ml`
...
- `efs`
  - Number of candidate vertices to consider during search.
  - A higher value will result in a more accurate search, but will also increase the time it takes to search.
  - Default: `200`
