...
You do not need to manually INSTALL these extensions anymore.

For Kuzu version before v0.11.3, or to install extensions that haven't been pre-installed, you'd have to set up a local extension server, as Kuzu doesn't provide the official extension server anymore.
