...
```
:::note[Note]
Uninstalling a currently loaded extension won't affect the running database instance. However, you won't be able to load that extension again until it's reinstalled.
:::
