...
| [vector](/extensions/vector) | Accelerate similarity search over float array data |
...
when a client script that embeds Kuzu is run. For this reason, the `LOAD EXTENSION` command must be
