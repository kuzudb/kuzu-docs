...
By default, Kuzu installs official extensions from `https://extension.kuzudb.github.io/`. However, if you are running Kuzu in an environment without internet access (e.g., an air-gapped environment), you can host your own extension server using Docker.
