...
| [duckdb](../extensions/external-databases/duckdb) | Scan data from an attached DuckDB database |
| [postgres](../extensions/external-databases/postgres) | Scan data from an attached PostgreSQL database |
