...
The Louvain method extracts communities from large networks by maximizing their
...
Kuzu implements parallel Louvain based on [Grappolo](https://hpc.pnl.gov/people/hala/grappolo.html).
