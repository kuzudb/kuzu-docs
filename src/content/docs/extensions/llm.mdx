---
title: "EMBEDDING Extension"
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

The **EMBEDDING extension** provides a `CREATE_EMBEDDING` function for creating text embeddings using API calls to supported providers.
