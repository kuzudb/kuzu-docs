...
remote file systems. The following extensions are provided via HTTPFS, each supporting a different remote file system:
...
:::note[Note]
The S3 and GCS extensions are implemented as features of the `httpfs` extension.
