...
Note: The `file_format` parameter is used to explicitly specify the file format of the given file instead of letting Kùzu autodetect the file format at runtime. When scanning from the Iceberg table, 
...
### Change Metadata Compression Code
