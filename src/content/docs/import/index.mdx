...
## `COPY FROM` with subqueries

You can copy data from a subquery into a node or relationship table.
This is useful when you need to transform data before inserting it into the database.
<LinkCard
  title="Import results of a query"
  href="/import/copy-query-results"
/>