...
## Import large relationship tables

Importing large relationship tables can use significant amounts of memory. If the memory used to
prepare the imported relationship table data comes close to exceeding the buffer pool size,
