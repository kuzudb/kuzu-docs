...
:::note[License]
All source code and pre-compiled binaries of Kuzu are distributed under the [MIT License](https://github.com/kuzudb/kuzu/blob/master/LICENSE). By installing and using Kuzu, you acknowledge and agree to these terms.
:::
