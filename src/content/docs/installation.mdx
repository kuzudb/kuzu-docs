---
title: Install Kuzu
description: Installation guide for Kuzu graph database across different platforms and programming languages with package managers.
---
...
:::note[License and Warranty]
All source code and pre-compiled binaries of Kuzu are distributed under the [MIT License](https://github.com/kuzudb/kuzu/blob/master/LICENSE) and are provided without warranty of any kind, express or implied. By installing and using Kuzu, you acknowledge and agree to these terms.
:::
