...
for x86-64 or [this one](https://github.com/kuzudb/kuzu/releases/download/v0.8.2/kuzu_cli-linux-aarch64.tar.gz)
...
Use a tool like cURL to download the latest version of the Kùzu CLI to your local machine. Alternatively,
simply copy-paste [this HTTPS URL](https://github.com/kuzudb/kuzu/releases/download/v0.8.2/kuzu_cli-windows-x86_64.zip)
into your browser.
...
You can use `pip` or `uv` (recommended)to install the Kùzu Python client library.
