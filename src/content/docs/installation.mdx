...
Add `.package(url: "https://github.com/kuzudb/kuzu-swift/", branch: "main")` to your `Package.swift` dependencies.
You can also use a specific version tag, e.g., `branch: "v0.11.0"`.
