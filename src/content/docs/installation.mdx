...
```bash
# x86-64
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/kuzu_cli-linux-x86_64.tar.gz
# aarch64
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/kuzu_cli-linux-aarch64.tar.gz
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/kuzu_cli-osx-universal.tar.gz
tar xzf kuzu_cli-*.tar.gz
./kuzu
```
...
simply open [this URL](https://github.com/kuzudb/kuzu/releases/download/v0.99.0/kuzu_cli-windows-x86_64.zip)
in your browser.

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/kuzu_cli-windows-x86_64.zip
```
...
Add `.package(url: "https://github.com/kuzudb/kuzu-swift/", branch: "v0.99.0")` to your `Package.swift` dependencies.
...
```bash
# x86-64
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/libkuzu-linux-x86_64.tar.gz
# aarch64
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/libkuzu-linux-aarch64.tar.gz
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/libkuzu-osx-universal.tar.gz
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.99.0/libkuzu-windows-x86_64.zip
```
