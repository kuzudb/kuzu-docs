...
simply copy-paste [this URL](https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_cli-linux-x86_64.tar.gz)
for x86-64 or [this one](https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_cli-linux-aarch64.tar.gz)
for aarch64 into your browser.

**x86-64**

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_cli-linux-x86_64.tar.gz
```

**aarch64**

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_cli-linux-aarch64.tar.gz
```
...
Use a tool like cURL to download the latest version of the Kùzu CLI to your local machine. Alternatively,
simply copy-paste [this HTTPS URL](https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_cli-windows-x86_64.zip)
into your browser.

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_cli-windows-x86_64.zip
```
...
Download the latest version [here](https://github.com/kuzudb/kuzu/releases/download/v0.6.0/kuzu_java.jar),
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/libkuzu-osx-universal.tar.gz
```
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/libkuzu-linux-x86_64.tar.gz
```

**aarch64**

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/libkuzu-linux-aarch64.tar.gz
```

**x86-64** ([old ABI](https://gcc.gnu.org/onlinedocs/libstdc++/manual/using_dual_abi.html))

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/libkuzu-linux-old_abi-x86_64.tar.gz
```
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.6.0/libkuzu-windows-x86_64.zip
```
