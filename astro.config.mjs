      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Create your first RDF graph",
              link: "/rdf-graphs/example-rdfgraph",
            },
            {
              label: "Query an RDF graph in Cypher",
              link: "/rdf-graphs/rdfgraphs-overview",
            },
            { label: "RDF bulk data import", link: "/rdf-graphs/rdf-import" },
            {
              label: "Preloaded RDFGraphs",
              link: "/rdf-graphs/rdfgraphs-repo",
            },
          ],
